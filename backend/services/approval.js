...
// NOTE: auto-approve was removed entirely at the owner's request — every
// scanned transaction waits in the Inbox until the owner approves it by hand
// (individually or via the "Approve All High Confidence" button, which is a
// user-initiated action, not automation).

module.exports = { approveTransaction, undoApproval };
